  ...
  BUY_JUDGMENT_BASIS: {
    ...
    options: createOptions([
      ...
      [
        'EVENT_RESPONSE',
        '이벤트반응형',
        '뉴스와 공시 등 주요 이벤트에 빠르게 반응해요.',
        'sparkles',
      ],
      [
        'INTUITION_SOCIAL_SIGNAL',
        '직관·사회신호형',
        '직관이나 주변 투자 신호를 참고해 판단해요.',
        'users',
      ],
