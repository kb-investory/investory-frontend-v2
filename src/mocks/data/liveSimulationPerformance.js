...
const returnPathByVariant = {
  ...
  1: [
    0, 0.8, 1.9, 2.7, 1.4, 0.2, -1, 0.5, 2.4, 3.8, 5.1, 4.2, 2.8, 4.6, 6.4, 7.2, 5.8, 6.9, 8.2, 6.7,
    5.9, 5,
  ],
  // 초반 부진과 역전을 거쳐 후반에 다시 치고 올라오는 최종 우승 경로다.
  2: [
    0, 0.3, 1.2, 2, 3.4, 4.8, 3.1, 1.2, -0.4, 1.8, 4.6, 6.9, 5.5, 7.8, 9.6, 8.1, 10.8, 12.2, 11.4,
    14.1, 15.6, 17,
  ],
  // 여러 차례 선두권을 오가지만 마지막에는 2위로 수렴한다.
  3: [
    0, 1.1, 0.4, 1.6, 2.8, 3.7, 4.9, 4, 5.3, 4.4, 3.6, 5.2, 6.5, 5.7, 7, 8.4, 7.3, 9.1, 8.5, 7.6,
    8.8, 8,
  ],
  // 초반 깜짝 선두와 급락·반등을 반복하는 변동성 높은 경로다.
  4: [
    0, -0.6, 1.7, 3.2, 4.6, 2.9, 5.7, 3.6, 1.1, -1.8, 0.7, 4.1, 2, -2.7, -4.5, -1.2, 2.6, 0.4, -3.8,
    -1.7, 0.9, -2,
  ],
}
